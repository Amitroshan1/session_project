...
SECRET_KEY = 'django-insecure-zmebyreof4b=j8_3)f1^(2q!auaw##z!6r+xvp+m!jz-v4o6p2'
...
# forntend/backend Site domain for Password Reset Link and Account Activation Link
# if using REActjs Vuejs Nextjs then you can replace with frontend domain
